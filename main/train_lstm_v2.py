...
from sentanalyzer.models.lstm_v2 import SentimentAnalyzer
...
updated_model_file = os.path.join(MODEL_DIR,CURR_EXP_NO,'lstm_v2.pt')
updated_metric_file = os.path.join(METRIC_DIR,CURR_EXP_NO,'metrics_v2.pt')
...
def test():
    ...
    model_path = r"E:\Users\VS_Code_Workspace\Python\VirtualEnvironments\sentanalyzer\sentanalyzer\experiments\exp_15d_12m_20y_20H_46M\lstm_v2.pt"
